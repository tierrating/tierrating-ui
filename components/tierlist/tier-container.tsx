...
export default function TierContainer({children, id, label, color}: {children: React.ReactNode, id: string, label: string, color: string}) {
    return (
        <div className="grid grid-cols-[auto_1fr] rounded-md overflow-hidden border border-border/60 mb-1">
